 ...
 */
public class VehiculoLorcaOrtegaFrancisco2223 {
    ...
    public VehiculoLorcaOrtegaFrancisco2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoLorcaOrtegaFrancisco2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
